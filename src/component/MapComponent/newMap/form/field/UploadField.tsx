...
export class UploadField extends MapComponent<IMapProps, IMapState> {
    static defaultProps = {
        map_form_f_title: '字段',
        map_form_f_default: '',
        map_form_f_state: '0',
        ...
        titleWidth: 110,
        currUnit: 2,
        map_form_f_type: 'MapComponent/newMap/form/field/UploadField'
    };
    ...
    public render() {
        ...
        const { map_form_f_title, map_form_f_cols, currUnit, map_form_f_state, map_form_f_hidden_t, titleWidth, id, selectedId, doChildDbClickToEdit } = this.props;
                        ...
                        >
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <Button style={{ width: '100px', borderRadius: '3px' }} size="default">上传</Button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
