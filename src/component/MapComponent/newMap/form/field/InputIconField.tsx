...
export class InputIconField extends MapComponent<IMapProps, any> {
	...
	public render() {
		...
		const { map_form_f_title, map_form_f_default, unit, currUnit, map_form_f_state, map_form_f_hidden_t, map_mi_ico, titleWidth, id, selectedId, map_form_f_disabled } = this.props;
