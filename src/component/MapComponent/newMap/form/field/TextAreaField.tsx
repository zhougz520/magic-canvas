...
export class TextAreaField extends MapComponent<IMapProps, any> {
	...
	public render() {
		...
		const { h, map_form_f_title, map_form_f_default, unit, currUnit, map_form_f_state, map_form_f_disabled, map_form_f_hidden_t, titleWidth, id, selectedId } = this.props;
