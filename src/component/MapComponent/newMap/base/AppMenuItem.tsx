...
import { MapComponent, IBaseProps } from '../..';
...
export class AppMenuItemClass extends MapComponent<IMapProps, any> {
    static defaultProps = {
        map_mi_txt: '按钮',
        map_mi_sa: false,
        map_mi_gl: false
    ...
    public render() {
        const { map_mi_txt, map_mi_dd, map_mi_ico, map_mi_si, map_mi_sa, selectedId, id, index, map_mi_gl } = this.props;
        ...
        return (
            ...
            <li
                className={`newMap-bottom ${map_mi_gl ? 'light' : 'default'}`}
...
export const AppMenuItem = AppMenuItemClass;
